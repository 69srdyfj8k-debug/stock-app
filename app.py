...
translations = {
    ...
    "English": {
        ...
        "p3_title": "💬 AI Assistant",
        "p4_title": "📈 Technical Chart",
...
# 🎯 選單改為 3 個 Tab 頁面 (亦可開啟第 4 個圖表頁面)
page_choice = st.sidebar.radio(t["page_select"], [t["p1_title"], t["p2_title"], t["p3_title"], t["p4_title"]])
...
if df is None or df.empty or len(df) < 2:
    ...
    # 💬 Tab 3：獨立 AI 助手頁面
    # ==========================================
    elif page_choice == t["p3_title"]:
        st.title(f"{t['assistant_title']} - {symbol}")
